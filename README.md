...
- <img src="https://usenami.io/favicon.ico" height="14"/> [signer-mcp](https://www.npmjs.com/package/@usenami/signer-mcp) - Sign CEX (Binance, OKX) and on-chain perp orders from any MCP-aware agent — the signing key never leaves an AWS Nitro Enclave; per-asset signature caps + on-demand attestation proof.
